 ...
 */
    PyErr_NoMemory(); __PYX_ERR(0, 336, __pyx_L1_error)
 ...
 */
    PyErr_NoMemory(); __PYX_ERR(0, 340, __pyx_L1_error)
 ...
 * 
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Group_not_found) < 0) __PYX_ERR(0, 404, __pyx_L1_error)
 ...
 */
    PyErr_NoMemory(); __PYX_ERR(0, 426, __pyx_L1_error)
 ...
 * 
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_location_not_found) < 0) __PYX_ERR(0, 482, __pyx_L1_error)
 ...
 * 
 */
      if (__Pyx_PrintOne(0, __pyx_kp_s_MEM_ERROR) < 0) __PYX_ERR(0, 509, __pyx_L1_error)

      /* "AlphaGo/go_data.pyx":510
 *         if not locations_list.locations:
 *             print("MEM ERROR")
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef short location
 */
    PyErr_NoMemory(); __PYX_ERR(0, 605, __pyx_L1_error)
 ...
 *     cdef short location
 */
    PyErr_NoMemory(); __PYX_ERR(0, 647, __pyx_L1_error)
...
static unsigned PY_LONG_LONG *__pyx_f_7AlphaGo_7go_data_get_zobrist_lookup(char __pyx_v_size) {
  unsigned PY_LONG_LONG *__pyx_v_zobrist_lookup;
  long __pyx_v_i;
  ...
  __Pyx_RefNannySetupContext("get_zobrist_lookup", 0);

  /* "AlphaGo/go_data.pyx":744
 ...
 *         raise MemoryError()
 */
  __pyx_v_zobrist_lookup = ((unsigned PY_LONG_LONG *)malloc((((__pyx_v_size * __pyx_v_size) * 2) * (sizeof(unsigned PY_LONG_LONG)))));

  /* "AlphaGo/go_data.pyx":745
 * 
 *     zobrist_lookup  = <unsigned long long *>malloc((size * size * 2) * sizeof(unsigned long long))
 *     if not zobrist_lookup:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 * 
 */
  __pyx_t_1 = ((!(__pyx_v_zobrist_lookup != 0)) != 0);
  if (__pyx_t_1) {

    /* "AlphaGo/go_data.pyx":746
 *     zobrist_lookup  = <unsigned long long *>malloc((size * size * 2) * sizeof(unsigned long long))
 *     if not zobrist_lookup:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    PyErr_NoMemory(); __PYX_ERR(0, 746, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_2 = ((__pyx_v_size * __pyx_v_size) * 2);
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "AlphaGo/go_data.pyx":750
 *     # initialize all zobrist hash lookup values
 *     for i in range(size * size * 2):
 *         zobrist_lookup[i] = np.random.randint(np.iinfo(np.uint64).max, dtype='uint64')             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_random); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_randint); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_iinfo); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_uint64); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 750, __pyx_L1_error)
    ...
    if (!__pyx_t_6) {
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 750, __pyx_L1_error)
      ...
      if (PyFunction_Check(__pyx_t_7)) {
        ...
        __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 750, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
        PyObject *__pyx_temp[2] = {__pyx_t_6, __pyx_t_8};
        __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 750, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_8 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_9, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 750, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_max); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyTuple_New(1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_GIVEREF(__pyx_t_7);
    PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_t_7);
    __pyx_t_7 = 0;
    __pyx_t_7 = PyDict_New(); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, __pyx_n_s_uint64) < 0) __PYX_ERR(0, 750, __pyx_L1_error)
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_10 = __Pyx_PyInt_As_unsigned_PY_LONG_LONG(__pyx_t_9); if (unlikely((__pyx_t_10 == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 750, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    (__pyx_v_zobrist_lookup[__pyx_v_i]) = __pyx_t_10;
  }

  /* "AlphaGo/go_data.pyx":752
 *         zobrist_lookup[i] = np.random.randint(np.iinfo(np.uint64).max, dtype='uint64')
 * 
 *     return zobrist_lookup             # <<<<<<<<<<<<<<
 */
  __pyx_r = __pyx_v_zobrist_lookup;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("AlphaGo.go_data.get_zobrist_lookup", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
#endif
{
  ...
  if (__Pyx_ExportFunction("get_zobrist_lookup", (void (*)(void))__pyx_f_7AlphaGo_7go_data_get_zobrist_lookup, "unsigned PY_LONG_LONG *(char)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
